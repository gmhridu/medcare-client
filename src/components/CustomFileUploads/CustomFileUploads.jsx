...
export default function ImageUpload({ filesToUpload, setFilesToUpload }) {
  ...
  //   await axios.post(
  //     `https://api.cloudinary.com/v1_1/dyq0ij1yk/image/destroy`,
  //     { public_id: publicId },
  //     {
  //       headers: {
  //         Authorization: `Bearer 932442926241698`,
  //       },
  //     }
  //   );
  // };
                ...
                return (
                  ...
                  >
                    <div className="flex items-center flex-1 p-2">
                      <div className="text-white w-36 rounded-md">
